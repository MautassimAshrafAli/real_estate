...
namespace admin.Models
{
    ...
    public partial class real_estateEntities : DbContext
    {
        public real_estateEntities()
            : base("name=real_estateEntities")
        {
        }
        ...
        public virtual DbSet<get_touch_user_info> get_touch_user_info { get; set; }
        public virtual DbSet<property> properties { get; set; }
        public virtual DbSet<properties_info> properties_info { get; set; }
        public virtual DbSet<top_properties> top_properties { get; set; }
        public virtual DbSet<V_AllProperties> V_AllProperties { get; set; }
        public virtual DbSet<V_TopOneProperties> V_TopOneProperties { get; set; }
